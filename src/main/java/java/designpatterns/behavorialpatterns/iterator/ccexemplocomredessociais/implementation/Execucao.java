...
import java.designpatterns.behavorialpatterns.iterator.ccexemplocomredessociais.implementation.domain.Facebook;
...
/* Abaixo, temos um pequeno menu que permite a seleção de uma rede social e, após
* isso, utilizaremos o padrão Iterator para enviar spams para esses contatos. */
