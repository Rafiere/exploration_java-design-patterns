package java.designpatterns.creationalpatterns.singleton.bbatributostatic;

import java.designpatterns.creationalpatterns.singleton.bbatributostatic.implementation.Runtime;
